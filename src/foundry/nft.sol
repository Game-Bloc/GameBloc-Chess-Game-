...
contract ArenaverseNFT is ERC721Enumerable, Ownable {
  ...
  constructor(
    ...
    mint(msg.sender, 1); // Mint the first token to the owner
  }

  // Internal function to override base URI
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    require(walletOfOwner(msg.sender).length + _mintAmount <= maxMintPerWallet, "Exceeds max mint per wallet");
  ...
  // Returns tokens owned by an address
